function [im_comb clim] = plot_spark_regression_stats_overlay(plot_axes,cbar_axes,im_session,trial_num,chan_num,plot_planes,clim,plot_on)
...
for ij = 1:num_planes
	...
	im_comb(start_y:start_y+im_session.ref.im_props.height-1,start_x:start_x+im_session.ref.im_props.width-1,1) = im_use;
	%im_comb(start_y:start_y+im_session.ref.im_props.height-1,start_x:start_x+im_session.ref.im_props.width-1,2) = im_use;
