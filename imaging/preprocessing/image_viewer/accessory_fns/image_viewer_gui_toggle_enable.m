...
set(handles.text_streamed_files,'enable',enable_str)
...
set(handles.popupmenu_roi_ts,'enable',enable_str)
set(handles.popupmenuspark_keep_inds,'enable',enable_str)
set(handles.edit_trial_range,'enable',enable_str)
set(handles.checkbox_streaming,'enable',enable_str)
