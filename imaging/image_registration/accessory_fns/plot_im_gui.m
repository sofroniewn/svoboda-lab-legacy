function data = plot_im_gui(handles,plot_on)
    ...
    plot_str = ['data = ' plot_function(1:end-2) '(handles.axes_images,im_session,trial_num,chan_num,plot_planes,c_lim,plot_on);'];
    eval(plot_str);
