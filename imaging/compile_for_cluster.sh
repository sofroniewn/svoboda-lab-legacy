...
./save_text_cluster
/usr/local/matlab-2010a/bin/mcc -R -singleCompThread -C -m /groups/freeman/home/freemanj11/code/wgnr/imaging/preprocessing/caTSA_generation/roiF_extract_cluster.m -a /groups/freeman/home/freemanj11/code/wgnr/imaging/preprocessing/
./roiF_extract_cluster
cd ..
