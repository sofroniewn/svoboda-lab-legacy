...
const double Xmaze_wall_gain[] = {}; /* wall gain multiplier */
...
const double Xmaze_initial_branch_for_fraction[] = {}; /* Starting branch forward position */
const double Xmaze_initial_left_wall[] = {}; /* Starting left wall pos */
const double Xmaze_initial_right_wall[] = {}; /* Starting right wall pos */
const double Xmaze_initial_for_cord[] = {}; /* Initial forward maze cordinate */
const double Xmaze_initial_lat_cord[] = {}; /* Initial lateral maze cordinate */
