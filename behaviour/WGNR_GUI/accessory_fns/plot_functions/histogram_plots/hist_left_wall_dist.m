function hist_left_wall_dist(axes_handle,session,setup,frac_range,keep_trial_types,keep_inds,col_mat)
...
for ij = keep_inds'
    cor_pos = session.data{ij}.trial_matrix(4,:) - session.data{ij}.trial_matrix(3,:);
