function hist_ytraj_position(axes_handle,session,setup,frac_range,keep_trial_types,keep_inds,col_mat)
...
for ij = keep_inds'
    cor_pos = session.data{ij}.processed_matrix(3,:);
