function hist_corridor_position(axes_handle,session,setup,frac_range,keep_trial_types,keep_inds,col_mat)
...
for ij = keep_inds'
    cor_pos = session.data{ij}.trial_matrix(3,:)./session.data{ij}.trial_matrix(4,:);
