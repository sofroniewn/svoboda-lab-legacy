function bar_trial_time(axes_handle,session,setup,frac_range,keep_trial_types,keep_inds,col_mat)
...
for ij = keep_inds'
    ...
    time = session.data{ij}.processed_matrix(1,:);
    mean_vals = time(end);
