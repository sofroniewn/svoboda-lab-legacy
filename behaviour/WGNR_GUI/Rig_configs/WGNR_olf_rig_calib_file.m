...
rig_config.rig_name = 'Behaviour_rig_olfactory'; % BASE DIRECTORY
...
rig_config.ai_channels_scim_logging = '7'; % SCIM LOGGING WILL BE USED TO RECORD SNIFFING
...
rig_config.dio_trial_test_trig = '8'; % TEST TRIGGER IS USED TO TURN ODOR ON AND OFF
