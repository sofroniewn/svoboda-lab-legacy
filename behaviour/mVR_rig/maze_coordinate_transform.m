...
for_left_wall_pos = maze.left_wall_traj(branch_id,2) + branch_fraction*cosd(maze.left_wall_angle(branch_id))*maze.length(branch_id);
for_right_wall_pos = maze.right_wall_traj(branch_id,2) + branch_fraction*cosd(maze.right_wall_angle(branch_id))*maze.length(branch_id);
