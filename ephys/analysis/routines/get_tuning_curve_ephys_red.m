function tuning_curve = get_tuning_curve_ephys_red(responseVar,var_tune,d,stim_name,keep_name,exp_type,id_type,time_range,trial_range,run_thresh,regressor_tune_type);
...
regressor_obj.bin_vals = var_tune;
...
regressor_obj.var_tune = var_tune;
