function output = summarize_tuning_sig_opto(d,clust_num)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    raster_mat_full = squeeze(d.s_ctk(8,:,keep_trials))';
    vals = mean(raster_mat_full(:,1000:1200),2);
    u_vals = unique(vals);
...
tc = zeros(length(group_ids),1);
    ...
    sense_mat = squeeze(d.s_ctk(8,:,keep_trials))';
