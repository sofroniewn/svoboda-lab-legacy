...
spike_times1 = sorted_spikes{clustnum1}.spike_times_ephys;
trials1 = sorted_spikes{clustnum1}.spike_trials;

spike_times1(~ismember(trials1,trial_range)) = [];
trials1(~ismember(trials1,trial_range)) = [];

spike_times2 = sorted_spikes{clustnum2}.spike_times_ephys;
trials2 = sorted_spikes{clustnum2}.spike_trials;
