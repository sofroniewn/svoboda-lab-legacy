function plot_clusters_tuning_paper4_both(all_anm,ps,order,plot_on,rasters,rasters_opto)
...
%if output_opto.r2 > 0.6
       ...
       text(0,.11+.73,sprintf('CC %g',ps.clean_clusters(ih)),'units','normalized','Color',[0 .5 0],'Fontsize',14,'backgroundcolor',[1 1 1])
       text(0,.11+.61,sprintf('RS %g',ps.regular_spikes(ih)),'units','normalized','Color',[0 .5 0],'Fontsize',14,'backgroundcolor',[1 1 1])
