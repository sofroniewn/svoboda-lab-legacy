...
d = [];
d.walls = err_abs_run_angle_error_mean{1}.data';
d.S1 = err_abs_run_angle_error_mean{2}.data';
d.V1 = err_abs_run_angle_error_mean{3}.data';
d.off = err_abs_run_angle_error_mean{4}.data';
opt = [];
opt.NaN = 'NaN';
opt.Inf = 'NaN';
opt.FileName = fullfile(local_python_save_path,'activation.json');
savejson('',d,opt);
